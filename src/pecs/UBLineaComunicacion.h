...
#ifndef UBLINEACOMUNICACION_H
#define UBLINEACOMUNICACION_H

#include <QWidget>
#include "gui/UBDockPaletteWidget.h"


class UBLineaComunicacion : public UBDockPaletteWidget
{
    Q_OBJECT
public:
    UBLineaComunicacion(QWidget *parent = 0);
