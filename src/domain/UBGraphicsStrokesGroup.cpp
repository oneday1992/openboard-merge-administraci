/*
 * Copyright (C) 2015-2016 D茅partement de l'Instruction Publique (DIP-SEM)
 *
 * Copyright (C) 2013 Open Education Foundation
 *
 * Copyright (C) 2010-2013 Groupement d'Int茅r锚t Public pour
 * l'Education Num茅rique en Afrique (GIP ENA)
 *
